...
command_parser = argparse.ArgumentParser(description='Use neural network to pridict image.')

command_parser.add_argument('--image_path', action='store',
...
command_parser.add_argument('--top_k', action='store',
                    dest='topk', type=int, default = 3,
                    help='Enter number of top most likely classes to view, default is 3.')

command_parser.add_argument('--cat_to_name', action='store',
...
# to print name of predicted flower with highest probability
